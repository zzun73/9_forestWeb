...
public class MemberDAO 
{
    ...
    public void pluscount(MemberBean member) throws Exception
    {
    	
        Connection conn = null;
        conn =  DBConnecter.getconnection();
        java.sql.Statement stmt= conn.createStatement();
        String sql="update JSP_MEMBER SET count1=count1+1 where id='pym529'";
    ...
    public void insertMember(MemberBean member) throws SQLException
    {
        ...
        try {
            ...
            String sql="insert into JSP_MEMBER values (?, ?, ?, ?, ?, ?, ?, ?, 0, ?, ?)";
            stringToDate(member);
            ...
            //pstmt.setInt(9, member.getCount1());
            pstmt.setInt(9, member.getCount2());
            pstmt.setString(10, member.getTime2());
