...
<head>
<jsp:useBean id="memberBean1" class="dao.MemberBean" />
...
<body>
          ...
          <div class="carousel-item active">
            <div class="container">
              <div class="row">
                <div class="col-md-4">
                  <div class="img-box">
                    <img id="cook_img" src="images/main.png" alt="" style="width : 15vw;">
                  </div>
                </div>
                <div class="col-md-8">
                  <div class="detail-box">
                    ...
                    <p>
                      모두의 안전과 모두의 행복을 위해<br>
                      더욱 더 발전된 서비스를 제공하는<br>
                      건강과 안전을 지키는<br>
                      여기는 배달 숲입니다.<br>
          ...
          <div class="carousel-item">
            <div class="container">
              <div class="row">
                <div class="col-md-4">
                  <div class="img-box">
                    <img src="images/autocycle.png" alt="">
                  </div>
                </div>
                <div class="col-md-8">
                  <div class="detail-box">
          ...
          <div class="item">
            <div class="box">
              <div class="btn_container">
                ...
                <span class="restaurant">피자 릿</span>
              </div>
              <div class="img-box">
            ...
            <div class="box">
              <div class="btn_container">
                ...
                <span class="restaurant">사보르 페루아노</span>
              </div>
              <div class="img-box">
          ...
          <div class="item">
            <div class="box">
              <div class="btn_container">
                ...
                <span class="restaurant">샘스스시</span>
              </div>
              <div class="img-box">
            ...
            <div class="box">
              <div class="btn_container">
                ...
                <span class="restaurant">델리 인디아</span>
              </div>
              <div class="img-box">
          ...
          <div class="item">
            <div class="box">
              <div class="btn_container">
                ...
                <span class="restaurant">티바 두마리치킨 </span>
              </div>
              <div class="img-box">
            ...
            <div class="box">
              <div class="btn_container">
                ...
                <span class="restaurant">케밥 파크</span>
              </div>
              <div class="img-box">
          ...
          <div class="item">
            ...
            <div class="box">
              <div class="btn_container">
                ...
                <span class="restaurant">과카몰레 스탠딩 타코</span>
              </div>
              <div class="img-box">
          ...
          <div class="item">
            <div class="box">
              <div class="btn_container">
                ...
                <span class="restaurant">미얌오브레드</span>
              </div>
              <div class="img-box">
          ...
          <div class="item">
            <div class="box">
              <div class="btn_container">
                ...
                <span class="restaurant">이디야 커피</span>
              </div>
              <div class="img-box">
          ...
          <div class="item">
            <div class="box">
              <div class="btn_container">
                ...
                <span class="restaurant">달콤 과일</span>
              </div>
              <div class="img-box">
          ...
          <div class="item">
            <div class="box">
              <div class="btn_container">
                ...
                <span class="restaurant">모어 디저트</span>
              </div>
              <div class="img-box">
  ...
  <section class="about_section layout_padding">
    <div class="container">
      ...
      <div class="P_picture">
        <div id="p_picture">
          <img src="images/p_1.png" width="200" height="300">
          <div></div>
          <img src="images/p_2.png" width="200" height="300">
          <div></div>
          <img src="images/p_4.png" width="200" height="300">
          <div></div>
          <img src="images/p_3.png" width="200" height="300">
        </div>
      </div>
      <br><br>
      ...
      <div id="caption">
        <div align="left">
          <font size="4"> 이름 : 남혁준<br></font>
          <font size="4"> 이메일 : hyeokjun@naver.com</font>
        </div>
        <div></div>
        <div align="left">
          <font size="4"> 이름 : 손지석<br></font>
          <font size="4"> 이메일 : Jisuk@naver.com</font>
        </div>
        <div></div>
        <div align="left">
          <font size="4"> 이름 : 신현빈<br></font>
          <font size="4"> 이메일 : misohb@naver.com</font>
        </div>
        <div></div>
        <div align="left">
          <font size="4"> 이름 : 장태환<br></font>
          <font size="4"> 이메일 : Jang@naver.com</font>
        </div>
